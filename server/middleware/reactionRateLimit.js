...
const reactionAttempts = new Map();
...
setInterval(() => {
    ...
    for (const userId of userIds) {
        ...
        if (tracker) {
            ...
            tracker.attempts = tracker.attempts.filter((attempt) => now - attempt < RATE_LIMIT_WINDOW_MS);
...
export function reactionRateLimit(req, res, next) {
