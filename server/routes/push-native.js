...
import { sendAPNs, isAPNsConfigured } from '../lib/apns.js';
const router = Router();
            ...
            try {
                if (deviceToken.platform === 'ios' && apnsConfigured) {
                    ...
                    try {
                        ...
                        webpush.setVapidDetails(process.env.VAPID_SUBJECT || 'mailto:admin@axle.app', process.env.VAPID_PUBLIC_KEY, process.env.VAPID_PRIVATE_KEY);
