 ...
 */
export function generateTitle(movements = [], category = 'CrossFit', date = new Date()) {
 ...
 */
export function extractPrimaryMovements(workoutBlocks) {
    const movements = [];
 ...
 */
export function generateWorkoutTitle(workout, category = 'CrossFit', date = new Date()) {
