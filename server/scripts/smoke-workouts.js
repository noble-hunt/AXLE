...
function printResult(label, value, color = colors.green) {
    console.log(`${color}${label}:${colors.reset} ${value}`);
}
async function testWorkout(name, request, seed) {
...
async function main() {
    ...
    results.push(await testWorkout('CrossFit with Barbell/Dumbbell/Bike', {
    ...
    results.push(await testWorkout('HIIT with Kettlebell/Rower', {
    ...
    results.push(await testWorkout('Strength Focus (Barbell/Dumbbell)', {
